...
public class StringEx {
    public static void main(String[] args) {
        ...
        // 문자열 변경이 가능
        // java.main.StringBuilder
        // java.main.StringBuffer
        ...
        // 4. toCharArray() : 문제열을 char 배열로 변환
        char[] ch2 = str1.toCharArray();
        System.out.println(Arrays.toString(ch2));

        // 5. indexOf(찾을문자) : 주어진 문자의 시작 위치 리턴 / 못찾으면 -1 => index 는 0 부터 시작
        // 5. indexOf(찾을문자, 시작위치) : 주어진 문자의 시작 위치 리턴 / 못찾으면 -1 => index 는 0 부터 시작
        ...
        System.out.println("astIndexOf(e) : " + str1.lastIndexOf("e"));
        System.out.println("astIndexOf(Java) : " + str1.lastIndexOf("Java"));

        // 7. contains() : 문자열이 포함되어 있는지 확인 후 true/false
        ...
        // 9. concat(문자열) : 문자열을 문자열 뒤로 연결
        System.out.println("concat(str2) : " + str1.concat(str2));

        // 10. replace(old 문자, new 문자) : old 문자를 new 문자로 변경 후 새로운 문자열로 리턴
        str1 = "Hellollo";
        System.out.println(str1.replace("ll", "!!")); // He!!o!!o
        System.out.println(str1.replaceAll("ll", "!!")); // He!!o!!o
        System.out.println(str1.replaceFirst("ll", "!!")); // He!!ollo
        System.out.println(str1); // Hellollo

        // 11. split("패턴 or 분리기호") : 문자열을 분리자로 나누어 문재 배열로 리턴
